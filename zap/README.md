...
[![Go Reference](https://img.shields.io/badge/go.dev-reference-007d9c?style=for-the-badge&logo=go&logoColor=white)](https://pkg.go.dev/github.com/airmrcr/go-problem/zap)
[![Build Status](https://img.shields.io/github/actions/workflow/status/airmrcr/go-problem/ci.yml?style=for-the-badge)](https://github.com/airmrcr/go-problem/actions/workflows/ci.yml)
[![Release](https://img.shields.io/github/v/release/airmrcr/go-problem?style=for-the-badge)](https://github.com/airmrcr/go-problem)
[![License](https://img.shields.io/github/license/airmrcr/go-problem?style=for-the-badge)](https://github.com/airmrcr/go-problem/blob/main/LICENSE.md)
...
``` sh
go get github.com/airmrcr/go-problem github.com/airmrcr/go-problem/zap go.uber.org/zap
```
...
import (
    ...
    "github.com/airmrcr/go-problem/zap"
    "go.uber.org/zap"
)
```
...
Documentation is available on [pkg.go.dev](https://pkg.go.dev/github.com/airmrcr/go-problem/zap#section-documentation).
...
[here](https://github.com/airmrcr/go-problem/issues).

## Contributors

If you want to contribute, you're a legend! Information on how you can do so can be found in
[CONTRIBUTING.md](https://github.com/airmrcr/go-problem/blob/main/CONTRIBUTING.md). We want your suggestions and pull
requests!

A list of contributors can be found in [AUTHORS.md](https://github.com/airmrcr/go-problem/blob/main/AUTHORS.md).

## License

Copyright © 2026 airmrcr

See [LICENSE.md](https://github.com/airmrcr/go-problem/raw/main/LICENSE.md) for more information on our MIT license.
